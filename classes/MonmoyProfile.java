...
public class MonmoyProfile implements ActionListener, IMonmoyProfile
{
	...
	private String f;
	public MonmoyProfile(String user)
	{
		f=user;
		
		frame = new JFrame("Monmoy");
		
		ImageIcon framelogo = new ImageIcon("icons/framelogo.jpg");
		ImageIcon monmoy= new ImageIcon("icons/monmoyprofile.png");
